...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-4">
        ...
        >
            <div
                class="grid grid-cols-[1fr_auto] gap-x-4 border-b border-sidebar-border/70 px-4 py-2 text-xs font-medium text-muted-foreground sm:grid-cols-[1.2fr_auto_auto_auto] dark:border-sidebar-border"
            >
                <span>Name</span>
                <span>Code</span>
            ...
            >
                <li
                    ...
                    :key="section.id"
                    class="grid grid-cols-[1fr_auto] gap-x-4 gap-y-1 px-4 py-3 text-sm sm:grid-cols-[1.2fr_auto_auto_auto]"
                >
                    <div class="min-w-0">
